/* MAIN MODULE */
var app = angular.module('MainApplication', ['ngSanitize','zy-Auth','zy-Router', 'ngAnimate', 'ngMaterial', 'jQueryScrollbar', 'HUD-ContentManager', 'HUD-Factory', 'HUD-Directives', 'ang-drag-drop', 'duScroll']); //
